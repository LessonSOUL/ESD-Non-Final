...
public class ListNeedActivity extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.listneed_activity);
        ...
        button_profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ListNeedActivity.this, ProfileActivity.class);
        ...
        button_list_documents.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ListNeedActivity.this, ListDocumentsActivity.class);
                startActivity(intent);
            }
        });
        ...
        button_list_history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ListNeedActivity.this, HistoryActivity.class);
                startActivity(intent);
            }
        });
        ...
        button_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ListNeedActivity.this, SettingActivity.class);
                startActivity(intent);
            }
        });
